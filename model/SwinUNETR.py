...
class SwinUNETR(nn.Module):
    ...
    def forward(self, x_in): ## x_in [4,1,96,96,96]
        ...
        # torch.Size([4, 1, 96, 96, 96]) torch.Size([4, 48, 96, 96, 96]) torch.Size([4, 48, 48, 48, 48]) torch.Size([4, 96, 24, 24, 24]) 
        # torch.Size([4, 192, 12, 12, 12]) torch.Size([4, 768, 3, 3, 3])

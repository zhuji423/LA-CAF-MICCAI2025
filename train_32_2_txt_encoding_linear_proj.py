...
from utils.utils_32_2_txt_encoding import dice_score, check_data, TEMPLATE,TEMPLATE_vein, get_key, NUM_CLASS,ORGAN_NAME
from optimizers.lr_scheduler import LinearWarmupCosineAnnealingLR
torch.multiprocessing.set_sharing_strategy('file_system')
from monai.utils import set_determinism
from validation_32_2_txt_encoding import validation
...
def main():
    ...
    ## logging
    parser.add_argument('--log_name', default='model2024/vein_full_train_CLIP_univer_32_2_class_N700_300_use_clip_organ_embedding_linear_proj', help='The path resume from checkpoint')
    ## model load

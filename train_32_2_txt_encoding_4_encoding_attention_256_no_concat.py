...
from model.Universal_model import Universal_model,Universal_model_attention
...
def process(args,snapshot_path):
    ...
    model = Universal_model_attention(img_size=(args.roi_x, args.roi_y, args.roi_z),is_concat=False,
...
def main():
    ...
    ## logging
    parser.add_argument('--log_name', default='model2024/7_2/vein_semi_full_717_4classes_attention_256_no_concat', help='The path resume from checkpoint')
    ## model load

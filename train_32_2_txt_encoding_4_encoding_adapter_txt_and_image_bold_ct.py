...
def main():
    ...
    ## logging
    parser.add_argument('--log_name', default='model2024/0905/vein_semi_full_717_4classes_attention_512_concat_4txt_img_adapter_bold', help='The path resume from checkpoint')
    ## model load
    ...
    parser.add_argument('--train_txt', nargs='+', default='_bold_full_train.txt')#_train_hessian_full.txt
    parser.add_argument('--val_txt', nargs='+', default='_bold_full_val.txt') #_val_hessian_full.txt
    parser.add_argument('--test_txt', nargs='+', default='_bold_full_test.txt') #_test_hessian_full.txt

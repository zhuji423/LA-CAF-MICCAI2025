...
from validation_4_txt_encoding_inference2 import validation
...
def main():
    ...
    ## logging
    parser.add_argument('--log_name', default='model2024/0715/vein_semi_full_717_4classes_attention_512_concat_4txt_img_adapter', help='The path resume from checkpoint')
    ## model load
    parser.add_argument('--backbone', default='unet', help='backbone [swinunetr or unet or dints or unetpp]')
    parser.add_argument('--resume', default="/pub/data/yangdeq/CLIP/data/vein/model2024/0715/vein_semi_full_717_4classes_attention_512_concat_4txt_img_adapter/unet_epoch:1001_batch_size:3_0.0008/1/epoch_340_validation_DICE_AVG:0.7617_test_DICE_AVG:0.7579.pth",\
    ...
    parser.add_argument('--store_num', default=1, type=int, help='Store model how often')

...
from model.Universal_model_4adapter import Universal_model_adapter
...
def main():
    ...
    ## logging
    parser.add_argument('--log_name', default='model2024/0715/vein_semi_full_717_4classes_attention_512_concat_4txt_adapter', help='The path resume from checkpoint')
    ## model load

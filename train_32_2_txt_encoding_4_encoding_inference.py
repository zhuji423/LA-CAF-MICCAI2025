...
from model.Universal_model import Universal_model_only_txt,Universal_model_attention,Universal_model
...
from validation_4_txt_encoding_inference import validation
...
def process(args,snapshot_path):
    ...
    # model = Universal_model_only_txt(img_size=(args.roi_x, args.roi_y, args.roi_z),
    ...
    while args.epoch < args.max_epoch:
        ...
        # if (args.epoch > args.max_epoch*0.1 and  args.epoch% args.store_num == 0 and args.epoch != 0) and rank == 0:
            ...
            val_model_mean_dice = validation(model, validation_loader, args, args.epoch,snapshot_path,val_transforms)
...
def main():
    ...
    ## logging
    parser.add_argument('--log_name', default='model2024/0715/vein_semi_full_717_4classes_only_txt', help='The path resume from checkpoint')
    ## model load
    parser.add_argument('--backbone', default='unet', help='backbone [swinunetr or unet or dints or unetpp]')
    parser.add_argument('--resume', default=r"/pub/data/yangdeq/CLIP/data/vein/model2024/6_27/vein_semi_full_717_4classes/unet_epoch:1001_0.0008/1/epoch_140_validation_DICE_AVG:0.7637_test_DICE_AVG:0.7596.pth",\
    ...
    snapshot_path = f'/pub/data/yangdeq/CLIP/data/vein/{args.log_name}/{args.backbone}_epoch:{args.max_epoch}_batch_size:{args.batch_size}_{args.lr}/{args.copy}'
